...
- **Mandatory Peer Dependencies**: For VisionCamera v4, `react-native-worklets-core` MUST be installed manually if you use Frame Processors, otherwise native headers will not be exposed to the compiler.
